...
/**
 */
public class MyAlertDailogEd1 extends Dialog implements
View.OnClickListener {
	...
	private View msView;
	public MyAlertDailogEd1(Context context) {
	...
	private void init() {
		View contentView = View.inflate(getContext(), R.layout.dailog_alert_ed1,
				null);
	...
	public void setHeightAndHint(int height,String hints){
		tv_content.setHeight(dip2px(context,height));
		tv_content.setHint(hints);
	}
