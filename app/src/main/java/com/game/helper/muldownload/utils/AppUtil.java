package com.game.helper.muldownload.utils;
...
public class AppUtil {
	...
	public static boolean hasShortcut(Context context) {
		...
		Cursor c = cr.query(CONTENT_URI, new String[] { "title", "iconResource" }, "title=?", new String[] { "G9游戏" }, null);
	...
	public static void addShortCut(Context context) {
		...
		// 设置属性
		shortcut.putExtra(Intent.EXTRA_SHORTCUT_NAME, "G9游戏");
