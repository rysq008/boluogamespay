package com.game.helper.download;
...
public class DownLoaderManger {
    ...
    private DbBtHelper helper;//数据库帮助类
    ...
    private DownLoaderManger(DbBtHelper helper, OnProgressListener listener) {
        this.helper = helper;
     ...
     * @return
     */
    public static synchronized DownLoaderManger getInstance(DbBtHelper helper, OnProgressListener listener) {
        if (manger == null) {
    ...
    public void start(String url) {
        ...
        map.put(url, info);
        //开始任务下载
        new BtDownLoadTask(map.get(url), helper, listener).start();
    }
