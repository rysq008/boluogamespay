...
/**
 * @Description
 * @Path com.game.helper.adapter.mine.ZhichuAdapter.java
 * @Author lbb
 * @Date 2016年8月19日 下午5:27:11
 * @Company 
 */
public class ZhichuAdapter  extends BaseAdapter{
	...
	public ZhichuAdapter(Context mContext,List<Trade> mList) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Trade mMineCollect=(Trade) getItem(position);
