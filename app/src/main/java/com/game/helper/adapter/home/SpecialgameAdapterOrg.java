 ...
 * @Company
 */
public class SpecialgameAdapterOrg extends BaseAdapter {
    ...
    public SpecialgameAdapterOrg(Context mContext, List<AppContent> mList, int tag, int listviewId) {
        super();
