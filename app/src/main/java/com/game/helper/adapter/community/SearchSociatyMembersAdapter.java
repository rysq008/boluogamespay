...
/**
 * @Description
 * @Path com.game.helper.adapter.community.SearchSociatyMembersAdapter.java
 * @Author lbb
 * @Date 2016年8月25日 下午3:53:34
 * @Company
 */
public class SearchSociatyMembersAdapter extends BaseAdapter {

    private Context mContext;
    protected LayoutInflater mInflater;
    List<GetGuildUserData> data = new ArrayList<GetGuildUserData>();

    public SearchSociatyMembersAdapter(Context mContext, List<GetGuildUserData> data) {
        super();
