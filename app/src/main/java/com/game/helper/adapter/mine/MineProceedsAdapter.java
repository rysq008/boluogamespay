...
/**
 * @Description
 * @Path com.game.helper.adapter.mine.MineProceedsAdapter.java
 * @Author lbb
 * @Date 2016年8月26日 下午6:52:19
 * @Company 
 */
public class MineProceedsAdapter extends BaseAdapter{

	private Context mContext;
	protected LayoutInflater mInflater;
	private List<Trade> mList=new ArrayList<Trade>();
	public MineProceedsAdapter(Context mContext,List<Trade> mList) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.item_listview_mine_proceeds, null);
	...
	class ViewHolder {
		...
		public void setData(Trade mMineCollect){
			...
			time.setText(TimeUtil.changeTimeFormat(mMineCollect.createTimeString, TimeUtil.TIME_FORMAT_XXXX_XX_XX_HH_MM));
