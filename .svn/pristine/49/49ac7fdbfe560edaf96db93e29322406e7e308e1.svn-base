...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0x59b8e6,
	...
	private static final int DEF_VISIBLE_ITEMS = 12;
	...
	private int wheelForeground = R.drawable.background;
	...
	private void initResourcesIfNecessary() {
		...
		if (topShadow == null) {
			topShadow = new GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORS);
		}
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT / 40;
...
//					TextView temView = (TextView) itemsLayout.getChildAt(i);
//					if(null == temView){
//						return false;
//					}
//					
//					if(index == i ){
//						temView.setTextColor(Color.GRAY);
//					}else{
//						temView.setTextColor(Color.BLACK);
//						
//					}
//				}
			}
