...
import com.game.helper.adapter.community.SquareDynamicAdapter.SquareDynamicListener;
...
/**
 * @Description  广场动态
 * @Path com.game.helper.fragment.community.SquareDynamicFragment.java
 * @Author lbb
 * @Date 2016年8月26日 上午9:41:49
 * @Company 
 */
public class SquareDynamicFragment extends BaseFragment  implements OnRefreshListener{
	PullToRefreshLayout refresh_view;

	LinearLayout mLinear_seting_comment;//评论行
	...
	public SquareDynamicFragment() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SquareDynamicFragment(BaseApplication application, Activity activity, Context context) {
	...
	protected void initEvents() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				((BaseActivity)getActivity()).startActivity(DynamicDetailsActivity.class,bundle);
			}
		});
	}
	...
	private void getRefresh() {
		...
		new  GetDynamicInfoTask(getActivity(),isStart, "", ""+page, new Back() {
	...
	public void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("SquareDynamicFragment");
		if(i==0){
			i=1;
		}else{
			currIndex=getArguments().getInt("currIndex", 0);
	...
	public void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPageEnd("SquareDynamicFragment"); 
	}
