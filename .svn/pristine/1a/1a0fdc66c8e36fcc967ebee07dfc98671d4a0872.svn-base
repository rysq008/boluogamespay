...
//		canvas.drawRect(surface.weekHeight, surface.width, surface.weekHeight, surface.width, surface.cellBgPaint);
	...
	private void drawCellBg(Canvas canvas, int index, int color) {
		...
		// canvas.drawCircle(z*3/2, y*3/2, surface.cellHeight/2-2, surface.cellBgPaint);// 大圆  
	}
...
//		}
	...
	private class Surface {
		...
		public int bgColor = Color.parseColor("#FFFFFF");//背景色
		private int textColor = Color.parseColor("#3ac3ff");//日期字体色
		private int weekColor = Color.parseColor("#333333");;//星期字体
		//private int textColorUnimportant = Color.parseColor("#666666");
		private int btnColor = Color.parseColor("#666666");//无用
		private int borderColor = Color.parseColor("#dcdcdc");//边框
		public int todayNumberColor = Color.parseColor("#ff6a74");//今日
		public int cellDownColor = Color.parseColor("#FFFFFF");
		public int cellSelectedColor = Color.parseColor("#99CCFF");//选择的日期颜色
		public Paint borderPaint;
		public Paint monthPaint;
		public Paint weekPaint;//星期字体
