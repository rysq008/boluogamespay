...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public void setTextColorStateTextView(int id){
		loadStateTextView.setTextColor(getResources().getColor(id));
	}
	public void setTextStateTextView(CharSequence  stt){
		loadStateTextView.setText(stt);
	}
	private void hide()
	{
		timer.schedule(5);
	...
	private void initView()
	{
		...
		loadingRelative = (RelativeLayout) loadmoreView.findViewById(R.id.loadmore_view);
	}
