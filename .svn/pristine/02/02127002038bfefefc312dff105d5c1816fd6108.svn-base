...
/**
 * @Description 关注的人
 * @Path com.game.helper.activity.community.MineFollowPeopleActivity.java
 * @Author lbb
 * @Date 2016年8月26日 上午11:33:07
 * @Company
 */
public class FollowPeopleActivity extends BaseActivity {
    ...
    TextView topTitle;
    @BindView(R.id.follows_listView)
    ListViewForScrollView follows_listView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_community_follow_people);
    ...
    protected void initView() {
        ...
        mFollowPeopleAdapter = new FollowPeopleAdapter(mContext, data, 0);
        follows_listView.setAdapter(mFollowPeopleAdapter);
        follows_listView.setOnItemClickListener(new OnItemClickListener() {

            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Bundle bundle = new Bundle();
                bundle.putString("userId", mFollowPeopleAdapter.getData().get(position).userId);
    ...
    protected void initData() {
        ...
        new GetFocusListTask(mContext, true, userId, "0", new Back() {
            ...
            public void success(Object object, String msg) {
                ...
                if (object != null && object instanceof GetFocusList) {
                    ...
                    if (m.data != null && m.data.size() >= 0) {
                        ...
                        SharedPreUtil.putStringValue(mContext, ACTION_GetFocusList1 + userId, new JsonBuild().setModel(object).getJson1());
                    }
                }
            }
            ...
            public void fail(String status, String msg, Object object) {
                String json = SharedPreUtil.getStringValue(mContext, ACTION_GetFocusList1 + userId, "");
    ...
    protected void onPause() {
        MobclickAgent.onPageEnd("FollowPeopleActivity");
        super.onPause();
    }

    @Override
    protected void onResume() {
        MobclickAgent.onPageStart("FollowPeopleActivity");
        super.onResume();
    }
