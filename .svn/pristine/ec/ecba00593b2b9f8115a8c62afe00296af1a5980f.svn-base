...
/**
 */
public class MyAlertDailog extends Dialog implements
View.OnClickListener {
	...
	private TextView tv_content,tv_contentT;
	...
	private void init() {
		View contentView = View.inflate(getContext(), R.layout.dailog_alert,
				null);
		...
		//wv_contentT = (WebView) findViewById(R.id.wv_contentT);
...
*/
	...
	public void setContentT(String text,int col) {
		//		if(text==null){
		//			tv_content.setVisibility(View.GONE);
		//		}
		//		else
		...
		if(text==null){
			...
			tv_contentT.setVisibility(View.VISIBLE);
			tv_contentT.setText(text);
			tv_contentT.setTextColor(context.getResources().getColor(col));
		}
	}
