...
/**
 * @Description
 * @Path com.game.helper.view.dialog.ShareDialog1.java
 * @Author lbb
 * @Date 2016年12月2日 下午4:02:16
 * @Company 
 */
public class ShareDialog1 {		
	...
	private int[] image={R.drawable.share_0015,R.drawable.shouye_209,R.drawable.shouye_207,R.drawable.ssdk_oks_classic_sinaweibo,R.drawable.shouye_205,R.drawable.ssdk_oks_classic_wechatmoments};
	private String[] name={"复制链接","QQ好友","QQ空间","新浪微博","微信好友","朋友圈"};
